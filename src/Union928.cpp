		...
		switch(moveStep)
			{
				case goRight:
				{
					...
					output = "The "+furnitureString +" is at your "+LRdirection+", "+directionString+ "o'clock direction. You are " + stringDistance +" meters away from it. ";
					break;
					//is_on_the_way();
				}
				case goWrong:
			...
			switch(moveStep)
			{
				...
				case moveHand:
				{
					if(!isGoDestination)
					{
						...
						{	
							//cout<<"moveHand 1:"<<"11111111111"<<endl;
			...
			switch(step)
			{
				...
				{	
					...
					if(environment == "ExampleLayoutHN01")
					{
						...
						double blue_cupboard[4] = { 0,0,0,0 };
						double blue_cupboard_level[2];
						double cupboard[3] = { 0,0,0 };
						double cupboard_centerline = 0;
						double cupboard_leftside_line = 0;
						double cupboard_rightside_line = 0;
						double cupboard_rightside_cut = 0;
						double glass_dining_table[4] = { -0.44,5.669,-2.644,4.616 };
						double wooden_dining_table[4] = { 0,0,0,0 };
						double fridge[4] = { 0,0,0,0 };
						double fridge_level[3] = { 0,0,0 };
						double fridge_center_line = 0;
